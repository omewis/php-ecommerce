...
<body class="mainbody">
  <div id="main">
    ...
    <div id="content">
      <div class="sectionone width_86 width_94 m-lr-auto">
        ...
        <div class="sectionone-item">
          <div class="item-cate">
            <img src="./assets/images/Mac.jpeg" alt="" class="cate3" />
            <p></p>
          </div>
        </div>
        <div class="sectionone-item">
          <div class="item-cate">
            <img src="./assets/images/camera2.png" alt="" class="cate4" />
            <p> </p>
          </div>
        </div>
        <div class="sectionone-item">
          <div class="item-cate">
            <img src="./assets/images/accessor5.png" alt="" class="cate5" />
            <p></p>
          </div>
        </div>
        <div class="sectionone-item">
          <div class="item-cate">
            <img src="./assets/images/64cbea270f3dff0019568869.webp" alt="" class="cate6" />
            <p> </p>
          </div>
        </div>
      </div>
      ...
      <div class="sectiontwo width_86 width_94 m-lr-auto">
        ...
        <div class="sectiontwo-about">
            ...
            <div class="sectiontwo-item js-nameproduct" id="2">
                ...
                <div class="item-sp">
                    <a href="cart.html?id=${product.id}" class="item-sp--name">Gaming Laptop</a>
                    <div class="item-sp-price">
            ...
            <div class="sectiontwo-item js-nameproduct" id="3">
                ...
                <div class="item-sp">
                    <a href="guava.html?id=8" >
                        <img src="./assets/images/i phone.png" alt="Phone">
                    </a>
                </div>
                <div class="item-sp">
                    <a href="guava.html?id=8" class="item-sp--name">i Phone 13 Pro Max</a>
                    <div class="item-sp-price">
            ...
            <div class="sectiontwo-item js-nameproduct" id="4">
                ...
                <div class="item-sp">
                    <a href="guava.html?id=2">
                        <img src="./assets/images/accessor5.png" alt="Phonr">
                    </a>
                </div>
                <div class="item-sp">
                    <a href="guava.html?id=2" class="item-sp--name">appel watch</a>
                    <div class="item-sp-price">
            ...
            <div class="sectiontwo-item js-nameproduct" id="4">
              ...
              <div class="item-sp">
                  <a href="cart.html?id=${product.id}">
                      <img src="./assets/images/headphone1.webp" alt="Phonr">
                  </a>
              </div>
              <div class="item-sp">
                  <a href="cart.html?id=${product.id}" class="item-sp--name"> JBl Headphone</a>
                  <div class="item-sp-price">
  ...
  <div class="sectionseven width_86 width_94 m-lr-auto mt50">
    <div class="sectionseven-delivery">
      <!-- delivery: giao hàng -->
      <h2 style="color: black;">Free home delivery within 24 hours</h2>
      <div>
        <a href="">
          <p>Learn more</p>
        </a>
    ...
    <div class="modal__registerlogin js-modal__registerlogin">
      ...
      <div class="modal__inner modal__register js-modal__register">
        ...
        <div class="inner__authform--controls">
          <button class="btn-registerModal js-btnregisterModal">Create Account</button>
      ...
      <div class="modal__inner modal__login js-modal__login">
        ...
        <div class="inner__authform--body">
          <div class="inner__authform--form">
            <div class="authform__item">
              <div>
                <input type="text" name="" placeholder="E-mail" id="contact-emailLO" onkeyup="validateEmailLO()">
                <span id="email-errorLO"></span>
              </div>
              <div>
                <input type="password" name="" placeholder="Password" id="contact-passwordLO"
                  onkeyup="validatePasswordLO()">
                <span id="password-errorLO"></span>
              </div>
            </div>
            <div class="authform__help">
              <button onclick="return validateFormLO()">Log In</button>
        ...
        <div class="inner__authform--header inner__authform--headercp">
          <p class="inner__authform--title">Sign Up</p>
          <p class="inner__authform--des">Create an account to manage orders and payment, and shipping information more
            easily.</p>
        </div>
        <div class="inner__authform--controls">
          <button class="btn-registerModal js-btnregisterModal">Create Account</button>
  ...
  <script>
    ...
    function handleRegistration(event) {
        ...
        let newId = users.length ? Math.max(users.map(user => user.id)) + 1 : 1;
